...
public class ParticionPorCategorias implements Constantes{
	...
	static public void particiona() throws IOException, ClassNotFoundException {
		...
		try {
			...
			gestion = new DAOPersona(ENCUESTADOS);
